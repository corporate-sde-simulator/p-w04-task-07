...
> **Welcome to Product-Track Week 4, Task 7!**
...
| `src/consensusManager.go` | Main source code - **has bugs to fix** |
| `src/logReplicator.go` | Supporting code - **may also have bugs** |
| `tests/logReplicator_test.go` | Test file - **add your tests here** |
